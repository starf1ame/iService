...
if __name__ == "__main__":
    print(imps['/usr/lib/libSystem.B.dylib'])
    print(imps['/usr/lib/libSystem.B.dylib']['_xpc_connection_set_event_handler'])

    for imp in imps:
        print(imp)
    
    for key in imps.libraries():
        print(key)

    print(next(imp for imp in imps if imp.name.startswith('_xpc')))
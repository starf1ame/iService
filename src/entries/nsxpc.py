...
class AuthVisitor(vs.SimVisitor):
    ...
    def visit_top_insn(self, insn):
        ...
        if isinstance(expr, vu.Assign) and isinstance(expr.dest, vu.LocalVar):
            ...
            elif isinstance(expr.source, vu.Call) and expr.source.func.ea in arc:
...
if __name__ == '__main__':
    ...
    with BatchMode():
        for entry in find_nsxpc():
            print(hex(entry), ida_name.get_ea_name(entry))
